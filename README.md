...
Complete, working system — clone, configure via `.env`/`config.h`, and run. Solves real problem: Server outages are discovered late.
...
- **Live:** `https://kero.10001mb.com/demo/infra-monitor` (placeholder)

## Installation
```bash
git clone https://github.com/KeroNaderDev/infra-monitor.git
cd infra-monitor
cp .env.example .env
